...
As we discuss in [High Signal Privacy](/privacy), not all intents should be propogated publicly, and MemBook is undesirable for orders with high signal. Memswap provides alternative solutions where privacy is preferred.
