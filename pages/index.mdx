...
[Mempool Order Distribution](/onchain-order-distribution): Memswap uses an Ethereum mempool orderbook that leverages a novel order distribution mechanic called _intentful transactions_. Where offchain orders lead to improved UX, users may opt-in to centralized orderbooks.
