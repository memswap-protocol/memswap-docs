...
[Onchain Order Distribution](/onchain-order-distribution): Memswap supports MemBook, an onchain orderbook that uses a novel order distribution mechanic called _intentful transactions_. Where offchain orders lead to improved UX, users may opt-in to centralized orderbooks.
