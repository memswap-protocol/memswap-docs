...
MemSwap is designed with integrating applications in mind. There are some key features for originators worth revisiting:
...
Originators may wish to host their own matchmaker rather than rely on a trusted third party. To do so, please check out the Guide to Running a Matchmaker

To learn more about integrating MemSwap, check out our [App Integration Guide](/originators/originator-integration-guide)
