## Understanding Matchmakers

Matchmakers are **trusted (third-party) auctioneers** that conduct order flow auctions on behalf of users that nominate them to improve order execution.
